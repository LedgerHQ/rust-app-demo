...
/*
const bagl_element_t ux_layout_nn_elements[] = {
#ifdef TARGET_NANOX
  // erase
  ...
  {{BAGL_LABELINE                       , 0x10,   0,  29, 128,  32, 0, 0, 0        , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_REGULAR_11px|BAGL_FONT_ALIGNMENT_CENTER, 0  }, NULL},
  ...
  {{BAGL_LABELINE                       , 0x10,   0,  12, 128,  32, 0, 0, 0        , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_REGULAR_11px|BAGL_FONT_ALIGNMENT_CENTER, 0  }, NULL},
...
/*
  ...
  const ux_layout_nn_params_t* params = (const ux_layout_nn_params_t*)ux_stack_get_current_step_params();
