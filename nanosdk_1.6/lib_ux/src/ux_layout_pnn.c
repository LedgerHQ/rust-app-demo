...
/*
const bagl_element_t ux_layout_pnn_elements[] = {
#ifdef TARGET_NANOX
  // erase
  ...
  {{BAGL_LABELINE                       , 0x10,   0,  37, 128,  32, 0, 0, 0        , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_REGULAR_11px|BAGL_FONT_ALIGNMENT_CENTER, 0  }, NULL },
  {{BAGL_LABELINE                       , 0x11,   0,  51, 128,  32, 0, 0, 0        , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_REGULAR_11px|BAGL_FONT_ALIGNMENT_CENTER, 0  }, NULL },
#else // TARGET_NANOX
  // erase
  ...
  {{BAGL_LABELINE                       , 0x10,  41,  12, 128,  32, 0, 0, 0        , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_REGULAR_11px, 0  }, NULL },
  {{BAGL_LABELINE                       , 0x11,  41,  26, 128,  32, 0, 0, 0        , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_REGULAR_11px, 0  }, NULL },
#endif // TARGET_NANOX
