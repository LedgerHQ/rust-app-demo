 ...
 */
CXCALL int cx_aes_init_key(const unsigned char WIDE *rawkey PLENGTH(key_len), unsigned int key_len,
 ...
 */
CXCALL CXPORT(CXPORT_ED_AES) int cx_aes_iv(const cx_aes_key_t WIDE *key PLENGTH(sizeof(cx_aes_key_t)), 
                                            int mode,
 ...
 */
CXCALL CXPORT(CXPORT_ED_AES) int cx_aes(const cx_aes_key_t WIDE *key PLENGTH(sizeof(cx_aes_key_t)),
                                         int mode,
                                         const unsigned char  WIDE *in PLENGTH(in_len), unsigned int in_len,
                                         unsigned char *out PLENGTH(out_len),  unsigned int out_len);
