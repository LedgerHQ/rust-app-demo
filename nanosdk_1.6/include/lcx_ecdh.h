 ...
 */
CXCALL int cx_ecdh(const cx_ecfp_private_key_t WIDE *pvkey PLENGTH(scc__cx_scc_struct_size_ecfp_privkey__pvkey),
                    int mode,
                    const unsigned char WIDE *P PLENGTH(P_len), unsigned int P_len,
                    unsigned char *secret PLENGTH(secret_len), unsigned int secret_len);
