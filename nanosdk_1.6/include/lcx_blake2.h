 ...
 */
CXCALL int cx_blake2b_init(cx_blake2b_t  *hash PLENGTH(sizeof(cx_blake2b_t)), unsigned int out_len);
 ...
 * @return algorithm identifier
 */
CXCALL int cx_blake2b_init2(cx_blake2b_t  *hash PLENGTH(sizeof(cx_blake2b_t)), unsigned int out_len,
                             unsigned char *salt PLENGTH(salt_len), unsigned int salt_len,
                             unsigned char *perso PLENGTH(perso_len), unsigned int perso_len);
