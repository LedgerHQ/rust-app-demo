 ...
 */
CXCALL int    cx_math_is_zero(const unsigned char WIDE *a PLENGTH(len), unsigned int len);
 ...
 *
 */
CXCALL void cx_math_powm(unsigned char *r PLENGTH(len),
 ...
 *
 */
CXCALL void cx_math_invintm(unsigned char *r PLENGTH(len),
                             unsigned long int a,
                             const unsigned char WIDE *m PLENGTH(len),
                             unsigned int len);
 ...
 * @param len   length p
 */
CXCALL int cx_math_is_prime(const unsigned char *p PLENGTH(len), unsigned int len);
