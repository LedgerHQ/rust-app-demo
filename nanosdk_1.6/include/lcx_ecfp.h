...
#define CX_CURVE_IS_WEIRSTRASS(c)      ( ((c)>CX_CURVE_WEIERSTRASS_START)    && ((c)<CX_CURVE_WEIERSTRASS_END) )

/** Return true if curve type is short weierstrass curve */
#define CX_CURVE_IS_TWISTED_EDWARD(c)  ( ((c)>CX_CURVE_TWISTED_EDWARD_START) && ((c)<CX_CURVE_TWISTED_EDWARD_END) )
...
CXCALL int cx_ecfp_is_valid_point(cx_curve_t curve,
                                   const unsigned char WIDE *P PLENGTH(P_len), unsigned int P_len);
 ...
 * @throws INVALID_PARAMETER
 */
CXCALL int cx_ecfp_is_cryptographic_point(cx_curve_t curve,
                                           const unsigned char WIDE *P PLENGTH(P_len), unsigned int P_len);
 ...
 * @throws INVALID_PARAMETER
 */
CXCALL int cx_ecfp_add_point(cx_curve_t curve,
                              unsigned char *R PLENGTH(X_len), const unsigned char WIDE *P  PLENGTH(X_len), const unsigned char WIDE *Q  PLENGTH(X_len),
                              unsigned int X_len);
...
CXCALL int cx_ecfp_scalar_mult(cx_curve_t curve,
                                unsigned char *P PLENGTH(P_len), unsigned int P_len,
                                const unsigned char WIDE *k PLENGTH(k_len), unsigned int k_len);
...
CXCALL int cx_ecfp_init_public_key(cx_curve_t curve,
                                    const unsigned char  WIDE *rawkey PLENGTH(key_len), unsigned int key_len,
                                    cx_ecfp_public_key_t *key PLENGTH(scc__cx_scc_struct_size_ecfp_pubkey_from_curve__curve));
 ...
 * @throws INVALID_PARAMETER
 */
CXCALL int cx_ecfp_init_private_key(cx_curve_t curve,
                                     const unsigned char WIDE *rawkey PLENGTH(key_len), unsigned int key_len,
                                     cx_ecfp_private_key_t *pvkey PLENGTH(scc__cx_scc_struct_size_ecfp_privkey_from_curve__curve));
 ...
 * @throws INVALID_PARAMETER
 */
CXCALL int cx_ecfp_generate_pair(cx_curve_t curve,
 ...
 * @throws INVALID_PARAMETER
 */
CXCALL int cx_ecfp_generate_pair2(cx_curve_t curve,
                                  cx_ecfp_public_key_t *pubkey  PLENGTH(scc__cx_scc_struct_size_ecfp_pubkey_from_curve__curve),
                                  cx_ecfp_private_key_t *privkey PLENGTH(scc__cx_scc_struct_size_ecfp_privkey_from_curve__curve),
                                  int keepprivate, 
                                  cx_md_t hashID);
