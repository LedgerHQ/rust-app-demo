 ...
 */
CXCALL int cx_hmac_ripemd160_init(cx_hmac_ripemd160_t *hmac PLENGTH(sizeof(cx_hmac_ripemd160_t)),
 ...
 * @return algorithm  identifier
 */
CXCALL int cx_hmac_sha256_init(cx_hmac_sha256_t *hmac PLENGTH(sizeof(cx_hmac_sha256_t)),
                                const unsigned char WIDE *key PLENGTH(key_len), unsigned int key_len);
 ...
 * @return algorithm  identifier
 */
CXCALL int cx_hmac_sha512_init(cx_hmac_sha512_t *hmac PLENGTH(sizeof(cx_hmac_sha512_t)),
                                const unsigned char WIDE *key PLENGTH(key_len), unsigned int key_len);
...
CXCALL int cx_hmac(cx_hmac_t *hmac PLENGTH(scc__cx_scc_struct_size_hmac__hmac),
                    ...
                    unsigned char *mac PLENGTH(mac_len), unsigned int mac_len);
/**
