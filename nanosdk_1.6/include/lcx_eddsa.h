 ...
 *
 */
CXCALL void cx_eddsa_get_public_key(const cx_ecfp_private_key_t WIDE *pvkey PLENGTH(scc__cx_scc_struct_size_ecfp_privkey__pvkey),
                                     cx_md_t hashID,
                                     cx_ecfp_public_key_t  *pukey PLENGTH(scc__cx_scc_struct_size_ecfp_pubkey_from_pvkey__pvkey), 
 ...
 */
CXCALL int cx_eddsa_sign(const cx_ecfp_private_key_t WIDE *pvkey PLENGTH(scc__cx_scc_struct_size_ecfp_privkey__pvkey ),
                          int mode,  cx_md_t hashID,
                          const unsigned char  WIDE *hash PLENGTH(hash_len), unsigned int hash_len,
                          const unsigned char  WIDE *ctx PLENGTH(ctx_len), unsigned int ctx_len,
 ...
 * @throws INVALID_PARAMETER
 */
CXCALL int cx_eddsa_verify(const cx_ecfp_public_key_t WIDE *pukey PLENGTH(scc__cx_scc_struct_size_ecfp_pubkey__pukey),
                            int mode, cx_md_t hashID, 
                            const unsigned char  WIDE *hash PLENGTH(hash_len), unsigned int hash_len,
                            const unsigned char  WIDE *ctx PLENGTH(ctx_len), unsigned int ctx_len,
