 ...
 */
CXCALL int cx_sha3_init(cx_sha3_t *hash PLENGTH(sizeof(cx_sha3_t)), unsigned int size);
 ...
 * @return algorithm identifier
 */
CXCALL int cx_keccak_init(cx_sha3_t *hash PLENGTH(sizeof(cx_sha3_t)), unsigned int size);
 ...
 * @return algorithm identifier
 */
CXCALL int cx_shake128_init(cx_sha3_t *hash PLENGTH(sizeof(cx_sha3_t)), unsigned int out_size);
 ...
 * @return algorithm identifier
 */
CXCALL int cx_shake256_init(cx_sha3_t *hash PLENGTH(sizeof(cx_sha3_t)), unsigned int out_size);
 ...
 * @return algorithm identifier
 */
CXCALL int cx_sha3_xof_init(cx_sha3_t *hash PLENGTH(sizeof(cx_sha3_t)), unsigned int size, unsigned int out_length);
