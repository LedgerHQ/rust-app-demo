 ...
 */
CXCALL int cx_rsa_init_public_key(const  unsigned char WIDE *exponent PLENGTH(exponent_len), unsigned int exponent_len,
                                   const  unsigned char WIDE *modulus PLENGTH(modulus_len), unsigned int modulus_len,
                                   cx_rsa_public_key_t  *key PLENGTH(sizeof(cx_rsa_public_key_t)+modulus_len));
 ...
 * @throws INVALID_PARAMETER
 */
CXCALL int cx_rsa_init_private_key(const unsigned char WIDE *exponent PLENGTH(exponent_len), unsigned int exponent_len,
                                    const unsigned char WIDE *modulus PLENGTH(modulus_len), unsigned int modulus_len,
                                    cx_rsa_private_key_t  *key PLENGTH(sizeof(cx_rsa_private_key_t)+2*modulus_len));
 ...
 * @throws INVALID_PARAMETER
 */
CXCALL int cx_rsa_generate_pair(unsigned int modulus_len,
                                 cx_rsa_public_key_t  *public_key PLENGTH(sizeof(cx_rsa_public_key_t)+modulus_len),
                                 cx_rsa_private_key_t *private_key PLENGTH(sizeof(cx_rsa_private_key_t)+2*modulus_len),
 ...
 * @throws INVALID_PARAMETER
 */
CXCALL int cx_rsa_sign(const cx_rsa_private_key_t WIDE *key PLENGTH(scc__cx_scc_struct_size_rsa_privkey__key),
                        int mode, cx_md_t hashID, 
                        const unsigned char WIDE *hash PLENGTH(hash_len), unsigned int hash_len,
                        unsigned char WIDE *sig PLENGTH(sig_len), unsigned int sig_len);
 ...
 * @throws INVALID_PARAMETER
 */
CXCALL int cx_rsa_verify(const  cx_rsa_public_key_t WIDE *key PLENGTH(scc__cx_scc_struct_size_rsa_pubkey__key),
                          int mode, cx_md_t hashID, 
                          const unsigned char WIDE *hash PLENGTH(hash_len), unsigned int hash_len,
                          const unsigned char WIDE *sig PLENGTH(sig_len), unsigned int sig_len);
 ...
 * @throws INVALID_PARAMETER
 */
CXCALL CXPORT(CXPORT_ED_RSA) int cx_rsa_encrypt(const cx_rsa_public_key_t WIDE *key PLENGTH(scc__cx_scc_struct_size_rsa_pubkey__key),
                                                 int mode, cx_md_t hashID, 
                                                 const unsigned char  WIDE *mesg PLENGTH(mesg_len), unsigned int mesg_len,
                                                 unsigned char WIDE *enc PLENGTH(enc_len), unsigned int enc_len);
 ...
 * @throws INVALID_PARAMETER
 */
CXCALL CXPORT(CXPORT_ED_RSA) int cx_rsa_decrypt(const cx_rsa_private_key_t WIDE *key PLENGTH(scc__cx_scc_struct_size_rsa_privkey__key),
                                                 int mode, cx_md_t hashID, 
                                                 const unsigned char WIDE *mesg PLENGTH(mesg_len), unsigned int mesg_len,
                                                 unsigned char WIDE *dec PLENGTH(dec_len), unsigned int dec_len);
