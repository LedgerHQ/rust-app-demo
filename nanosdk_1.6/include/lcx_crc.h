 ...
 *
 */
CXCALL unsigned short cx_crc16( const void WIDE *buffer PLENGTH(len), size_t len);

#define CX_CRC16_INIT 0xFFFF

/** Accumulate more data to crc */
CXCALL unsigned short cx_crc16_update(unsigned short crc, const void WIDE *buffer PLENGTH(len), size_t len);
