...
pub mod ui;
use bindings::*;
use bagls::{Bagl, rect::Rect, labelline::LabelLine, icon::Icon};
...
extern "C" fn sample_main() {
    ...
    const bagl_ui_sample_nanos: &[Bagl] = &[
        Bagl::RECT(Rect::new().pos(32, 32).dims(20, 20).fill(true)),
        Bagl::RECT(Rect::new().pos(10, 64).dims(10, 30).fill(true)),
        Bagl::LABELLINE(LabelLine::new().pos(20,20).dims(50,50)),
        Bagl::ICON(Icon::new()),
    ];
